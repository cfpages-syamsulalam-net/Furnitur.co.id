---
article_id: FUR-04-07
title: "Mengapa Meja atau Kursi Goyang? Diagnosis Racking sebelum Mengencangkan Sekrup"
slug: "diagnosis-furnitur-goyang-racking"
description: "Separate uneven-floor contact, loose fasteners, failed joint, deformed frame, missing brace, and overload before action."
status: outline
publication_date: "2025-07-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: FUR-04
primary_intent: "Diagnose wobble and racking."
reader_community: "Furnitur.co.id"
reader_address: "Sobat Furnitur.co.id"
final_route: "/artikel/diagnosis-furnitur-goyang-racking.html"
...
# Mengapa Meja atau Kursi Goyang? Diagnosis Racking sebelum Mengencangkan Sekrup

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mengapa Meja atau Kursi Goyang? Diagnosis Racking sebelum Mengencangkan Sekrup”
- **Reader and situation:** Owner facing an unstable chair, table, or cabinet.
- **Reader outcome:** Separate uneven-floor contact, loose fasteners, failed joint, deformed frame, missing brace, and overload before action.
- **Primary intent:** Diagnose wobble and racking.
...
- **Scope boundary:** Excludes structural repair steps and tip-over anchoring; FUR-13-04 owns repair choice and FUR-15-01 owns anchoring risk.
- **Final public route:** `/artikel/diagnosis-furnitur-goyang-racking.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mengapa Meja atau Kursi Goyang? Diagnosis Racking sebelum Mengencangkan Sekrup**.
...
- **Exact Markdown to insert:** `![Ilustrasi Meja TV](/wp-content/uploads/2023/12/Meja-TV.png)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Meja TV` as relevant content media; no pixels were inspected.
...
- `/meja` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Mengapa Meja atau Kursi Goyang? Diagnosis Racking sebelum Mengencangkan Sekrup”.
