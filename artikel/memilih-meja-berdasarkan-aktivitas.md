---
article_id: FUR-02-03
title: "Memilih Meja dari Aktivitas: Makan, Kerja, Rapat, Konsol, dan Samping"
slug: "memilih-meja-berdasarkan-aktivitas"
description: "Match surface size, support layout, edge, clearance, stability, and mobility to the intended activity."
status: outline
publication_date: "2025-05-07"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: FUR-02
primary_intent: "Select a table form by activity."
reader_community: "Furnitur.co.id"
reader_address: "Teman Furnitur.co.id"
final_route: "/artikel/memilih-meja-berdasarkan-aktivitas.html"
...
# Memilih Meja dari Aktivitas: Makan, Kerja, Rapat, Konsol, dan Samping

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Memilih Meja dari Aktivitas: Makan, Kerja, Rapat, Konsol, dan Samping”
- **Reader and situation:** Buyer comparing tables that share a similar silhouette but serve different tasks.
- **Reader outcome:** Match surface size, support layout, edge, clearance, stability, and mobility to the intended activity.
- **Primary intent:** Select a table form by activity.
...
- **Scope boundary:** Excludes chair fit and full room layout; FUR-05-03 and FUR-08-03 own those calculations.
- **Final public route:** `/artikel/memilih-meja-berdasarkan-aktivitas.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memilih Meja dari Aktivitas: Makan, Kerja, Rapat, Konsol, dan Samping**.
...
- `FUR-02-01` → `/artikel/memilih-kursi-berdasarkan-aktivitas.html` — Memilih Kursi Berdasarkan Aktivitas, Durasi, dan Pengguna
...
- **Tie back to this article:** Keep the explanation specific to “Memilih Meja dari Aktivitas: Makan, Kerja, Rapat, Konsol, dan Samping”.
