---
article_id: FUR-05-06
title: "Furnitur untuk Anak, Lansia, dan Pengguna dengan Mobilitas Terbatas"
slug: "furnitur-untuk-ragam-kemampuan"
description: "Translate reach, strength, balance, transfers, vision, cognition, and caregiver needs into adjustable or testable furniture requirements."
status: outline
publication_date: "2025-08-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: FUR-05
primary_intent: "Adapt furniture to varied abilities."
reader_community: "Furnitur.co.id"
reader_address: "Kawan Furnitur.co.id"
final_route: "/artikel/furnitur-untuk-ragam-kemampuan.html"
...
# Furnitur untuk Anak, Lansia, dan Pengguna dengan Mobilitas Terbatas

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Furnitur untuk Anak, Lansia, dan Pengguna dengan Mobilitas Terbatas”
- **Reader and situation:** Family or facility seeking inclusive use without stereotyping users.
- **Reader outcome:** Translate reach, strength, balance, transfers, vision, cognition, and caregiver needs into adjustable or testable furniture requirements.
- **Primary intent:** Adapt furniture to varied abilities.
...
- **Scope boundary:** Excludes clinical prescription and hazard compliance; professionals own medical assessment and FUR-15-04 owns child-specific hazards.
- **Final public route:** `/artikel/furnitur-untuk-ragam-kemampuan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Furnitur untuk Anak, Lansia, dan Pengguna dengan Mobilitas Terbatas**.
...
- **Purpose for this article:** Freeze the verified editorial scope for `furnitur.co.id` and prevent family research from overriding this project's actual catalog boundaries.
...
- **TOPIC-GATE:** G-03, G-04, G-18, G-19
...
- `FUR-05-04` → `/artikel/tinggi-tempat-tidur-dan-ruang-transfer.html` — Tinggi Tempat Tidur dan Ruang Transfer untuk Bangun, Berbaring, dan Merawat
- `FUR-05-05` → `/artikel/menghitung-kapasitas-penyimpanan.html` — Menghitung Kapasitas Penyimpanan dari Barang, Frekuensi Akses, dan Jangkauan
- `FUR-05-07` → `/artikel/sirkulasi-dan-jangkauan-sekitar-furnitur.html` — Sirkulasi dan Jangkauan di Sekitar Furnitur: Ukur dengan Skenario, Bukan Tebakan
- `FUR-05-08` → `/artikel/uji-coba-furnitur-sebelum-membeli.html` — Uji Coba Furnitur Sebelum Membeli: Postur, Gerak, Jangkauan, dan Kelelahan
...
- **Tie back to this article:** Keep the explanation specific to “Furnitur untuk Anak, Lansia, dan Pengguna dengan Mobilitas Terbatas”.
