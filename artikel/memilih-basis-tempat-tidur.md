---
article_id: FUR-02-05
title: "Tempat Tidur dan Basis Kasur: Platform, Slat, Divan, Bunk, dan Adjustable"
slug: "memilih-basis-tempat-tidur"
description: "Explain support, ventilation, height, movement, access, storage, and maintenance implications of common bases."
status: outline
publication_date: "2025-05-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: FUR-02
primary_intent: "Select a bed base configuration."
reader_community: "Furnitur.co.id"
reader_address: "Teman Furnitur.co.id"
final_route: "/artikel/memilih-basis-tempat-tidur.html"
...
# Tempat Tidur dan Basis Kasur: Platform, Slat, Divan, Bunk, dan Adjustable

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tempat Tidur dan Basis Kasur: Platform, Slat, Divan, Bunk, dan Adjustable”
- **Reader and situation:** Resident matching mattress, user mobility, storage, and room constraints.
- **Reader outcome:** Explain support, ventilation, height, movement, access, storage, and maintenance implications of common bases.
- **Primary intent:** Select a bed base configuration.
...
- **Scope boundary:** Excludes mattress comfort science and child bunk safety; mattress choice is external and FUR-15-04 owns child hazards.
- **Final public route:** `/artikel/memilih-basis-tempat-tidur.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tempat Tidur dan Basis Kasur: Platform, Slat, Divan, Bunk, dan Adjustable**.
...
- **Exact Markdown to insert:** `![Ilustrasi Tempat Tidur](/wp-content/uploads/2023/12/Tempat-Tidur.png)`
...
- `FUR-02-04` → `/artikel/memilih-sistem-penyimpanan.html` — Sistem Penyimpanan: Lemari, Kabinet, Laci, Rak, dan Display
...
- **Tie back to this article:** Keep the explanation specific to “Tempat Tidur dan Basis Kasur: Platform, Slat, Divan, Bunk, dan Adjustable”.
